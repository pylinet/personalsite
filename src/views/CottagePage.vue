...
const items = {
  ...
  companyrole2: "",
  headerimage: "/src/assets/images/Cottage-IllustrationInterior.jpg",
  headerimagealt: "Interior 3D rendering of a living room and kitchen.",
  image1: "/src/assets/images/Cottage-Axon.png",
  image1alt: "3D Axonometric drawing of an accessory dwelling unit design.",
  image2: "/src/assets/images/Cottage-ElevationsAndSections.jpg",
  image2alt: "Axonometric drawing of a Cottage ADU.",
  image3: "/src/assets/images/Cottage-Interior.jpg",
